...
class StoreService with MyApiMethods {
  ...
  static String Function(int) get _collectionBuyById =>
      (int id) => '/store/collection/$id/buy';
  ...
  Future buyCollectionById(int collectionId) async =>
      await post(_collectionBuyById(collectionId));
}
